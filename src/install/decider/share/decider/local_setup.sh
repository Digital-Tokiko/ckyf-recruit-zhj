...
: ${AMENT_CURRENT_PREFIX:="/home/mizu/workspace/homework_ws/recruit/src/install/decider"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/decider/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/decider/environment/path.sh"
